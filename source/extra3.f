...
c     ############################################################
c     ##                                                        ##
c     ##  subroutine extra3a  --  user defined extra potentials  ##
c     ##                                                        ##
c     ############################################################
c
c
c     "extra3a" calculates any additional user defined potential
c     contribution and also partitions the energy among the atoms
c     double loop
c
c
...
c     ############################################################
c     ##                                                        ##
c     ##  subroutine extra3b  --  user defined extra potentials  ##
c     ##                                                        ##
c     ############################################################
c
c
c     "extra3b" calculates any additional user defined potential
c     contribution and also partitions the energy among the atoms
c     neighbor list
c
c
