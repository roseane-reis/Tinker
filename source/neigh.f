...
c     doctlst     logical flag to rebuild charge transfer neighbor list
...
c
      ...
      real*8 vbufx,cbufx
      real*8 mbufx,ubufx
      real*8 ctbuf2,ctbufx 
      real*8, allocatable :: xvold(:)
      real*8, allocatable :: yvold(:)
      real*8, allocatable :: zvold(:)
      real*8, allocatable :: xctold(:) 
      real*8, allocatable :: yctold(:) 
      real*8, allocatable :: zctold(:) 
