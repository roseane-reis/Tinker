...
c     dewaldcut   cutoff distance for direct space dispersion Ewald summation
c     usolvcut    cutoff distance for dipole solver preconditioner
c     use_ewald   logical flag governing use of Ewald summation
c     use_dewald  logical flag governing use of dispersion Ewald summation
