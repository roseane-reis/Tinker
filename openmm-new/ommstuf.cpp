 ...
 */
 ...
 void setupSystemParticles (OpenMM_System* system, FILE* log) {
 ...
 */
  ...
  void setupCMMotionRemover (OpenMM_System* system, FILE* log) {
 ...
 */
  ...
  void freeConstraintMap (struct ConstraintMap* map) {
...
void mapConstraints (struct ConstraintMap* map, FILE* log) {
 ...
 */
 ...
 int checkForConstraint (struct ConstraintMap* map,
...
void setupAmoebaBondForce (OpenMM_System* system,
...
void setupAmoebaAngleForce (OpenMM_System* system,
...
void setupAmoebaInPlaneAngleForce (OpenMM_System* system,
                                  int removeConstrainedBonds, FILE* log) {
...
void setupAmoebaStretchBendForce (OpenMM_System* system,
                                 int removeConstrainedBonds, FILE* log) {
...
void setupAmoebaUreyBradleyForce (OpenMM_System* system,
                                 int removeConstrainedBonds, FILE* log) {
...
void setupAmoebaOutOfPlaneBendForce (OpenMM_System* system, FILE* log) {
...
void setupAmoebaImproperTorsionForce (OpenMM_System* system, FILE* log) {
...
void setupAmoebaTorsionForce (OpenMM_System* system, FILE* log) {
...
void setupAmoebaPiTorsionForce (OpenMM_System* system, FILE* log) {
...
void setupAmoebaTorsionTorsionForce (OpenMM_System* system, FILE* log) {
   ...
   char (*ktt)[20] = (char(*)[20])ktrtor__.ktt;
